...
$(function() {
    ...
    function ajaxGiphy(gifSearch) {
        $.ajax({
            ...
            return $("#info-panel").append("<img src='" + data.data[randomNumber].images.downsized_medium.url + "' class='giphyPic'>")
